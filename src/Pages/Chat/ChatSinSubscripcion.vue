  ...
  <div class="app-container">
    ...
    <header class="app-header">
      ...
      <div class="header-icons">
        <i class="fa-solid fa-house-chimney" style="font-size: 35px; color: #a1360b; margin-right: 15px;"></i>
      </div>
    </header>
    ...
    <main class="app-content">
        <section class="section">
            ...
            <label id="nombreVivero" style="font-weight: bold; margin-top: 10px;" for="">PREMIUM</label>
        </section>
