    ...
    <div class="app-container">
      ...
      <main class="app-content">
          <section class="section">
              ...
              <label id="nombreVivero" style="font-weight: bold; margin-top: 10px;" for="">Subscripcion Premium</label>
          </section>
      ...
      <div class="textConversacion">
        ...
        <div>
          <i class="fa-solid fa-right-to-bracket" style="font-size: 35px; margin-bottom: 5px; color: white;"></i>
        </div>
      </div>
      <!-- Footer Navigation -->
...
.contenidoChat{
    ...
    background: gray;
    color: white;
    /* Elimina cualquier width fijo para tamaño automático */
    width: auto;
    height: auto;
